...
void initialize() {
    ...
    g_verbLookup["kill"] = V_ATTACK;
    g_verbCanonical["kill"] = "kill";
    g_verbSynonyms[V_ATTACK].push_back("kill");
    g_verbLookup["murder"] = V_ATTACK;
    g_verbCanonical["murder"] = "kill";
    g_verbSynonyms[V_ATTACK].push_back("murder");
    g_verbLookup["slay"] = V_ATTACK;
    g_verbCanonical["slay"] = "kill";
    g_verbSynonyms[V_ATTACK].push_back("slay");
    g_verbLookup["dispatch"] = V_ATTACK;
    g_verbCanonical["dispatch"] = "kill";
    g_verbSynonyms[V_ATTACK].push_back("dispatch");
