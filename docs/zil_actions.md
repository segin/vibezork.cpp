...
- [x] AXE-F - Axe handling (Troll interaction)
...
- [x] MAZE-11-FCN - Maze room handler
...
- [x] TROLL-FCN - Troll combat (via NPCSystem)
...
- [x] LAKE-PSEUDO - Lake pseudo-object (1actions.zil:3177-3184)
...
- [x] PAINT-PSEUDO - Studio paint pseudo-object (1actions.zil:3222-3225)
...
- [x] CAVE2-ROOM - Cave room handler (1actions.zil:2416-2430)
- [x] BOOM-ROOM - Gas room explosion handler (1actions.zil:2446-2467)
...
- [x] LLD-ROOM - Land of Living Dead room handler (1actions.zil:1058-1077)

## Progress
- Total: 114 actions
- Implemented: 114 / 114 (100% complete)
- In Progress: 0
- Remaining: 0
